...
public class TestGroups {
    ...
    public static final String LESSON_TEMPLATE = "lesson-template";
    public static final String LESSON = "lesson";
    public static final String SMOKE = "smoke";

    public static final String LOCK_STUDENT = "group-student";
    public static final String LOCK_COACH = "group-coach";
